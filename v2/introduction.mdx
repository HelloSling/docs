...
- **RCS** — Rich messages with cards, carousels, images, and interactive suggestion chips.
- **Truecaller messaging** — Branded, verified messages delivered through Truecaller.
