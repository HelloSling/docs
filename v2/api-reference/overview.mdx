...
| Truecaller | `truecaller` | [/send-truecaller](/v2/api-reference/send-truecaller) | Branded verified messages; `fallback_sms` and `fallback_sms_sender` for SMS fallback |
