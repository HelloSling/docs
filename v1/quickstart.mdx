...
<Steps>
  <Step title="Get your API token">
    ...
    If you need help with this step, see the [Authentication](/v1/authentication) page for a detailed walkthrough.
  </Step>
...
<CardGroup cols={3}>
  <Card title="Send SMS guide" icon="message-sms" href="/v1/guides/send-sms">
    Full parameter reference for SMS — groups, contacts, callbacks, and more.
  </Card>
  <Card title="Send RCS guide" icon="comment-dots" href="/v1/guides/send-rcs">
    Rich messages with cards, carousels, images, and interactive suggestions.
  </Card>
  <Card title="SMS API reference" icon="code" href="/v1/api-reference/send-sms">
