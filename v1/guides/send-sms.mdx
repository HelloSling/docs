...
<ParamField body="callback" type="string">
  A publicly accessible URL on your server. Sling will send a `POST` request to this URL when delivery status changes. See the [callbacks guide](/v1/guides/callbacks) for payload details.
</ParamField>
