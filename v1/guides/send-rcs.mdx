...
The `suggestions` array accepts several action types beyond simple replies. See the [RCS suggestions reference](/v1/api-reference/rcs-suggestions) for the full list of available types including URL links, dialers, location pins, and calendar events.
